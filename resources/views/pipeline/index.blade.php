                    ...
                    <li class="relative py-5 pl-4 pr-6 hover:bg-gray-50 sm:py-6 sm:pl-6 lg:pl-8 xl:pl-6">
                        <div class="flex items-center justify-between space-x-4">
                            <div class="min-w-0 space-y-3">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="block">
                                        <h2 class="text-sm font-medium">
                                            @if ($pipeline->github_webhook_id && $pipeline->twitter_access_code)
                                                It's all good, man
                                            @endif
                                ...
                                <a target="_blank" href="https://github.com/{{ $pipeline->repository}}" class="relative group flex items-center space-x-2.5">
                            ...
                            <div class="flex-col items-end flex-shrink-0 hidden space-y-3 sm:flex">
                                ...
                                <form action="{{ route('pipeline.destroy', $pipeline) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <button class="relative text-sm font-medium text-red-500 hover:text-red-900">
                                        Delete pipeline
                                    </button>
                                </form>
